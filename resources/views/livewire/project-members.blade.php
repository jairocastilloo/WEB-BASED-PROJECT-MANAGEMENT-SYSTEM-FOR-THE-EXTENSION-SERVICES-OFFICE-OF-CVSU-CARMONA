<div>
    ...
    <div class="btn-group ms-3 mt-2 mb-2 shadow">
        <button type="button" class="btn btn-sm rounded border border-1 border-warning btn-gold shadow"
            id="btnAddMember" data-bs-toggle="modal" data-bs-target="#addAssigneeModal">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" id="addMembersCloseButton"
                        data-bs-dismiss="modal">Cancel</button>

                    <button type="button" id="saveMembersButton" class="btn btn-primary"
