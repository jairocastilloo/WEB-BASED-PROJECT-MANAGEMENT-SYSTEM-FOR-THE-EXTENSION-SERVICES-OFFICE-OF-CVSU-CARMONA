<div>
    ...
    <div class="basiccont word-wrap shadow">
        ...
        <div class="shadow text-center p-2">
            <button type="button" class="btn btn-sm rounded btn-gold shadow" wire:click="pastshow(1)">
        ...
        <div class="text-center p-2 border border-bottom-2">
            <button type="button" class="btn btn-sm rounded btn-gold shadow" wire:click="pastshow(0)">
