<div class="basiccont word-wrap shadow mt-2">
    ...
    <div class="alert alert-danger alert-dismissible fade show ms-2 mt-1" role="alert" id="emailError"
        ...
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"
            onclick="redirectToHomepage()"></button>
    </div>
                    ...
                    <form data-url="{{ route('subtasks.uploadaccomplishment') }}" id="accomplishmentForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group date" id="startDatePicker">
                                <input type="text" class="form-control" id="subtaskstartdate" name="subtaskstartdate"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group date" id="endDatePicker">
                                <input type="text" class="form-control" id="subtaskenddate" name="subtaskenddate"
                                    placeholder="mm/dd/yyyy" />
                        ...
                        <div class="container mb-3 p-0">
                            ...
                            <select class="selectpicker w-100 border subtaskcontributors" name="subtaskcontributors[]"
                                id="subtaskcontributors" multiple aria-label="Select Contributors"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="accomplishment_file" accept=".pdf, .docx"
