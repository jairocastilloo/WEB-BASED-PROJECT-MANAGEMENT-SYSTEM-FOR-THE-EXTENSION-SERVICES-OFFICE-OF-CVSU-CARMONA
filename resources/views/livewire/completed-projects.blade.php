<div>
    ...
    <div class="basiccont word-wrap shadow">
        ...
        <div class="m-2 mb-0 text-center" @if ($xCompletedProjects==0)style="display: none;" @endif>
            ...
            <div class="mb-1 d-flex justify-content-start small">
                ...
                <div class="form-check">
                    <input class="form-check-input small" type="checkbox" wire:click="toggleSelectionCompletedProjects($event.target.checked)" @if($showOnlyMyCompletedProjects==1) checked @endif>
            ...
            @endif
            <input type="text" class="form-control border border-2 mb-2" id="inputSearchCompletedProjects" placeholder="Enter title...">
            <button type="button" class="btn btn-sm btn-outline-success px-3" id="btnSearchCompletedProjects">Search Project</button>
        ...
        <div class="shadow text-center p-2">
            <button type="button" class="btn btn-sm shadow rounded border border-1 btn-gold border-warning text-body" wire:click="showCompletedProjects(1)">
        ...
        <div class="container p-0">
            ...
            <nav class="border-bottom">
                <ul class="pagination justify-content-center m-1">
                    ...
                    @else
                    <li class="page-item">
                        <a class="page-link" wire:click="changePageCompletedProjects({{ $currentPageCompletedProjects - 1 }})" rel="prev"><i class="bi bi-caret-left-fill"></i></a>
                    </li>
                    @endif

                    <li class="page-item text-center mx-2">
                        <h6 class="fw-bold my-0 mt-2 small">{{ $currentPageCompletedProjects . ' of ' . $totalPagesCompletedProjects }}</h6>
                    ...
                    @else
                    <li class="page-item">
                        <a class="page-link" wire:click="changePageCompletedProjects({{ $currentPageCompletedProjects + 1 }})"><i class="bi bi-caret-right-fill"></i></i></a>
                    </li>
                    @endif
        ...
        <div class="text-center p-2 border border-bottom-2">
            <button type="button" class="btn btn-sm shadow rounded border border-1 btn-gold border-warning text-body" wire:click="showCompletedProjects(0)">
