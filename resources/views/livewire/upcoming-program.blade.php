<div>
    ...
    <div class="basiccont word-wrap shadow">
        ...
        <div class="m-2 mb-0 text-center" @if ($yUpcomingPrograms==0)style="display: none;" @endif>
            ...
            <div class="mb-1 d-flex justify-content-start small">
                ...
                <div class="form-check">
                    <input class="form-check-input small" type="checkbox" wire:click="toggleSelectionUpcomingPrograms($event.target.checked)" @if($showOnlyMyUpcomingPrograms==1) checked @endif>
            ...
            @endif
            <input type="text" class="form-control border border-2 mb-1" id="inputSearchUpcomingPrograms" placeholder="Enter title...">
            <button type="button" class="btn btn-sm btn-outline-success px-3" id="btnSearchUpcomingPrograms">Search Project</button>
        ...
        <div class="shadow text-center p-2">
            <button type="button" class="btn btn-sm shadow rounded border border-1 btn-gold border-warning text-body" wire:click="showUpcomingPrograms(1)">
        ...
        <div class="container p-0">
            ...
            <nav class="border-bottom">
                <ul class="pagination justify-content-center m-1">
                    ...
                    @else
                    <li class="page-item">
                        <a class="page-link" wire:click="changePageUpcomingPrograms({{ $currentPageUpcomingPrograms - 1 }})" rel="prev"><i class="bi bi-caret-left-fill"></i></a>
                    </li>
                    @endif

                    <li class="page-item text-center mx-2">
                        <h6 class="fw-bold my-0 mt-2 small">{{ $currentPageUpcomingPrograms . ' of ' . $totalPagesUpcomingPrograms }}</h6>
                    ...
                    @else
                    <li class="page-item">
                        <a class="page-link" wire:click="changePageUpcomingPrograms({{ $currentPageUpcomingPrograms + 1 }})"><i class="bi bi-caret-right-fill"></i></i></a>
                    </li>
                    @endif
        ...
        <div class="text-center p-2 border border-bottom-2">
            <button type="button" class="btn btn-sm shadow rounded border border-1 btn-gold border-warning text-body" wire:click="showUpcomingPrograms(0)">
