<div>
    ...
    <div class="m-2 p-2 border" style="width:345px;">
        ...
        <label class="ms-2 small form-label text-secondary fw-bold">Find Activity</label>
        ...
        <span class="invalid-feedback small fw-bold text-end" id="errorAccount">
            Please enter a search term to find activity.
        </span>
    ...
    <div class="container-fluid approvalcontainer">
        <table class="approvaltable">
            <thead>
                <tr>
                    <th class="p-2 text-center bg-light editname"> NAME</th>
