    ...
    <div class="basiccont word-wrap shadow mt-2">
        ...
        <div class="border-bottom p-2 selectoutputdiv" data-value="{{ $outputType }}">
            ...
            <p class="lh-1 ps-5" data-id="{{ $output->id }}">
                {{ $output->output_name . ': ' .  $output->totaloutput_submitted }} / <span
                    class="expectedoutput">{{ $output->expectedoutput }} </span>
                <input type="hidden" class="shadow numberInput" id="numberInput" name="numberInput" pattern="\d{5}"
                    title="Please enter exactly 5 digits" maxlength="5" value="{{ $output->expectedoutput }}">
            </p>
            @endif
            @endforeach
        </div>
        ...
        <div class="dropdown btn-group ms-3 mt-2 mb-3 shadow">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item small hrefnav border-bottom" data-bs-toggle="modal"
                    data-bs-target="#addoutputmodal">
        ...
        <div class="text-center">
            ...
            <div> <button type="button" class="btn btn-md rounded border border-1 btn-light shadow mb-2 d-none"
                    id="cancelOutput">
                    Cancel
                </button></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="outputform">
                        ...
                        <div class="mb-3">
                            <label for="assigneeSelect" class="form-label">Select the type of output to be
                                submitted.</label>
                        ...
                        <div class="row divhover pt-2 pb-1 ps-1 outputnamediv d-none">
                            ...
                            <div class="col-3">
                                <input type="number" class="shadow numberInput" id="outputneeded" name="outputneeded[]"
                                    pattern="\d{5}" title="Please enter exactly 5 digits" maxlength="5" value="0">
                            </div>
                    ...
                    <div class="w-60">
                        <button type="button" class="btn btn-success addmoreoutput-btn btn-sm d-none"> Add more Output
                        </button>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-md rounded border border-1 btn-light shadow"
                        id="cancelAddOutput" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-md rounded btn-gold shadow" id="btnAddOutput">Add
                        Output</button>
                </div>
            </div>
        </div>
