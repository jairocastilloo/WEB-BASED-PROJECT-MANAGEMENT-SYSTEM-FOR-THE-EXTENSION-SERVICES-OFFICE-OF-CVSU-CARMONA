            ...
            function handleError() {
                ...
                if (titleNgProgram != "") {
                    ...
                    if (programTitle.trim() === '') {
                        ...
                        document.getElementById('currentprogramtitle').nextElementSibling.querySelector('.invalid-feedback strong').textContent = 'Program Title is required.';
                        hasErrors = true;
                    }
                    ...
                    if (programLeader.length === 0) {
                        ...
                        document.querySelector('.currentprogramleader').nextElementSibling.querySelector('.invalid-feedback strong').textContent = 'Program Leader is required.';
                        hasErrors = true;
                    }
                }
                ...
                if (projectTitle.trim() === '') {
                    ...
                    document.getElementById('currentprojecttitle').nextElementSibling.querySelector('.invalid-feedback strong').textContent = 'Project Title is required.';
                    hasErrors = true;
                }
                ...
                if (projectLeader.length === 0) {
                    ...
                    document.querySelector('.currentprojectleader').nextElementSibling.querySelector('.invalid-feedback strong').textContent = 'Project Leader is required.';
                    hasErrors = true;
                }
                ...
                if (document.getElementById('currentprojectstartdate').value === '') {
                    ...
                    document.getElementById('currentprojectstartdate').parentElement.nextElementSibling.querySelector('.invalid-feedback strong').textContent = 'Project Start Date is required.';
                    hasErrors = true;
                }
                ...
                if (document.getElementById('currentprojectenddate').value === '') {
                    ...
                    document.getElementById('currentprojectenddate').parentElement.nextElementSibling.querySelector('.invalid-feedback strong').textContent = 'Project End Date is required.';
                    hasErrors = true;
                }
                ...
                if (projectEndDate <= projectStartDate) {
                    document.getElementById('currentprojectenddate').parentElement.classList.add('is-invalid');
                    document.getElementById('currentprojectenddate').parentElement.nextElementSibling.querySelector('.invalid-feedback strong').textContent = 'Project End Date must be after the Start Date.';
                    hasErrors = true;
                }
