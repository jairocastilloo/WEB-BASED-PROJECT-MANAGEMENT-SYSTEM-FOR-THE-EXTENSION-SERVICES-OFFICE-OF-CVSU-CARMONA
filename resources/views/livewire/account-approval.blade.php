    ...
    <nav class='nav-pagelink d-flex justify-content-center'>
        <ul class="pagination">
            ...
            @for ($i = 1; $i <= $totalPages; $i++) <li
                class="page-item {{ $i === $currentPage ? 'active' : 'number-link' }}"
    ...
    <div class="tablecontainer">
        <table class="approvaltable">
            ...
            <tbody>
                ...
                <tr class="accountRow"
                    data-name="{{ $pendinguser->name . ' ' . $pendinguser->middle_name . ' ' . $pendinguser->last_name }}"
                    data-email="{{ $pendinguser->email }}" data-id="{{ $pendinguser->id }}">
                    ...
                    <td class="p-2 actions">
                        <div class="text-center">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-success border shadow-sm"
                                wire:click="approveAsCoordinator('{{ $pendinguser->id }}')">
                                <b class="small">Coordinator</b>
                            </button>
                            <button type="button" class="btn btn-sm btn-outline-success border shadow-sm"
                                wire:click="approveAsImplementer('{{ $pendinguser->id }}')">
                                <b class="small">Implementer</b>
                            </button>
                            <span class="ms-2 small" id="loadingSpan[{{ $pendinguser->id}}]"
                                style="display: none;">Sending Email..</span>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert"
                                id="emailError[{{ $pendinguser->id}}]" style="display: none;">
                    ...
                    <td class="p-2 cancel text-center">
                        ...
                        <span class="ms-2 small" id="loadingSpanDecline[{{ $pendinguser->id}}]"
                            style="display: none;">Sending Email..</span>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert"
                            id="emailErrorDecline[{{ $pendinguser->id}}]" style="display: none;">
                            <!-- Your error message goes here -->
