        ...
        <div class="m-2 mb-0 text-center" @if ($xCompletedActivities==0)style="display: none;" @endif>
            ...
            <div class="mb-1 d-flex justify-content-start small">
                ...
                <div class="form-check">
                    <input class="form-check-input small" type="checkbox" wire:click="toggleSelectionCompletedActivities($event.target.checked)" @if($showOnlyMyCompletedActivities==1) checked @endif>
