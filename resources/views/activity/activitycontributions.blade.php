                    ...
                    <div class="basiccont word-wrap shadow">
                        ...
                        <div class="p-2 pb-0 border-bottom">
                            ...
                            <p class="lh-1 ps-5"><b>Related Program <i> (if any)</i>:</b>
                                {{ $actcontribution->relatedPrograms }}</p>
                            <p class="lh-1 ps-5"><b>Numbers of Clientele/Beneficiaries <i>(if any)</i>:</b>
                                {{ $actcontribution->clientNumbers }}</p>
                            <p class="lh-1 ps-5"><b>Agency <i>(if any)</i>:</b> {{ $actcontribution->agency }}</p>
                            <p class="lh-1 ps-5"><b>Submitted In:</b>
                                {{ \Carbon\Carbon::parse($actcontribution->created_at)->format('F d, Y') }}</p>
                            <p class="lh-1 ps-5"><b>Submitted By:</b>
                                {{ $submitter[0]->name . ' ' . $submitter[0]->last_name }}</p>
