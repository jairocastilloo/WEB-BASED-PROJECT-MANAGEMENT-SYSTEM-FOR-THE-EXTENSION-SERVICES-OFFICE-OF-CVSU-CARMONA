                ...
                <div class="col-lg-9">
                    ...
                    <div class="basiccont word-wrap shadow">
                        ...
                        <div class="p-2 pb-0 border-bottom">
                            ...
                            <p class="lh-1 ps-5"><b>Rendered Date:</b> {{ \Carbon\Carbon::createFromFormat('Y-m-d', $contribution->date)->format('F d') . ' to ' . \Carbon\Carbon::createFromFormat('Y-m-d', $contribution->enddate)->format('F d') }}</p>
                            <p class="lh-1 ps-5"><b>Submitted In:</b> {{ \Carbon\Carbon::parse($contribution->created_at)->format('F d, Y') }}</p>
