                            ...
                            <form data-url="{{ route('activities.uploadaccomplishment') }}" id="accomplishmentForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="client-numbers" name="client-numbers"
                                        placeholder="Enter Client Numbers" value="0" min="0" step="1">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="accomplishment_file"
                                        accept=".pdf, .docx" name="accomplishment_file">
                                    <span class="invalid-feedback" role="alert">
                                        <strong></strong>
                                    </span>
                                </div>
