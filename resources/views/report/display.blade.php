                        ...
                        <div class="container p-0">
                            <div class="row">
                                <div class="col-xl-3">
                                    ...
                                    <div class="basiccont rounded shadow mb-4">
                                        <div class="border-bottom pt-2 text-center bggreen">
                                            <h6 class="fw-bold small" style="color:darkgreen;">Completed Activities
                                            </h6>
                                        </div>
                                        <div class="p-2 py-3 text-center">
                                ...
                                <div class="col-xl-3">
                                    <div class="basiccont rounded shadow mb-4">
                                        <div class="border-bottom pt-2 text-center bggreen">
                                            <h6 class="fw-bold small" style="color:darkgreen;">Ongoing Activities
                                            </h6>
                                        </div>
                                        <div class="p-2 py-3 text-center">
                                    ...
                                    <div class="basiccont rounded shadow mb-4">
                                        <div class="border-bottom pt-2 text-center bggreen">
                                            <h6 class="fw-bold small" style="color:darkgreen;">Upcoming Activities
                                            </h6>
                                        </div>
                                        <div class="p-2 py-3 text-center">
                                    ...
                                    <div class="basiccont rounded shadow mb-4">
                                        <div class="border-bottom pt-2 text-center bggreen">
                                            <h6 class="fw-bold small" style="color:darkgreen;">Overdue Activities
                                            </h6>
                                        </div>
                                        <div class="p-2 py-3 text-center">
                                ...
                                <div class="col-xl-6">
                                    <div class="basiccont rounded shadow">
                                        <div class="border-bottom ps-3 pt-2 bggreen text-center">
                                            <h6 class="fw-bold small" style="color:darkgreen;">Project Activities
                                                Overview</h6>
                                        </div>
