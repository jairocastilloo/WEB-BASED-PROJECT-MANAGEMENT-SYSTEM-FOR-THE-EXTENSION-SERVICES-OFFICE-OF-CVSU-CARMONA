...
<div class="maincontainer border border-start border-end border-bottom border-top-0">
        ...
        <div class="basiccont word-wrap shadow">
            ...
            <div class="p-2 pb-0 ps-3 border-bottom">
                ...
                <p class="lh-1 mb-0">&nbsp;&nbsp;&nbsp;<b>Activities Completed:</b>
                    {{ $completedActivities . ' out of ' . $allActivities }}</p>
            ...
            <div class="modal fade" id="terminalReportModal" tabindex="-1" aria-labelledby="terminalReportModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form data-url="{{ route('projects.uploadterminal') }}" id="terminalForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group date" id="endDatePicker">
                                        <input type="text" class="form-control" id="projectenddate"
                                            name="projectenddate" placeholder="mm/dd/yyyy" />
                                        <span class="input-group-append">
                                            <span class="input-group-text bg-light d-block">
                                                <i class="bi bi-calendar-event-fill"></i>
                                            </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="terminal_file" accept=".pdf, .docx"
                                        name="terminal_file">
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="button"
                                class="btn btn-md rounded btn-gold shadow submitTerminal">Upload</button>
                        </div>
    ...
    -->
        ...
        <div class="basiccont word-wrap shadow">
            ...
            <div class="p-2 pb-1 ps-3 divhover border-bottom projsubmission-div small" data-id="{{ $submission->id }}"
