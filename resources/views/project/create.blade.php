                        ...
                        <div class="container-fluid" id="objform">
                            <form id="form2">
                                ...
                                <div class="container-fluid objectiveSetContainer mb-2 p-2" data-value="0">
                                    ...
                                    <button type="button" class="addObjective-btn btn btn-sm btn-green"><b class="small">Add Objective</b>
                                    </button>
                                    <button type="button" class="removeObjectiveSet-btn btn btn-sm btn-red px-5 d-block mx-auto"><b class="small">Remove Objective Set</b>
                                    </button>


                                </div>
                            </form>
                            <button type="button" class="btn btn-md btn-green w-100" id="addObjectiveSet-btn"><b class="small">Add Objective Set</b>
                            </button>
