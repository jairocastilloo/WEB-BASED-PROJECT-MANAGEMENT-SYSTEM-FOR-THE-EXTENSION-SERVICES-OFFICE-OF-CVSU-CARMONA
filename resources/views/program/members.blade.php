            ...
            <div class="col-lg-10">
                ...
                <div class="basiccont p-3 rounded shadow">
                    ...
                    <div class="btn-group dropdown mt-3 shadow">
                        <button type="button" class="btn btn-sm rounded btn-gold shadow" data-bs-toggle="dropdown"
                        ...
                        <div class="dropdown-menu border-warning">
                            ...
                            <a class="dropdown-item small hrefnav border-bottom"
                                href="{{ route('programs.display', ['programid' => $indexprogram->id, 'department' => $indexprogram->department ]) }}">
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newproject">Create Project within program
                    <i>"{{ $indexprogram->programName }}"</i>
                </h5>
            ...
            <div class="modal-body">
                ...
                <form id="programform1" data-url="{{ route('programs.create') }}">
                    ...
                    <div class="container mb-3 p-0">
                        ...
                        <select class="selectpicker w-100 border programleader-1" name="programleader-1[]"
