    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="basiccont rounded shadow pb-3">
                    ...
                    <div class="ms-3 mt-2 btn-group shadow">
                        <button type="button" class="btn btn-sm shadow rounded border border-1 btn-gold border-warning text-body" id="addproj">
            ...
            <div class="col-lg-2">
                ...
                @livewire('overdue-program', ['department' => $department, 'programid' => $indexprogram->id, 'zOverduePrograms' => 1])
            </div>
